...
<html lang="en">
  ...
  <body>
    ...
    <a class="navbar-brand" href="#">
      ...
      <a href="<?= base_url('konfirmasi')?>"  style="margin-right: 850px; font-size: 15px; font-family: Source Sans Pro; color: white; text-decoration: none;">Konfirmasi Pembayaran</a>
    </a>
				...
				<div class="card">
					...
					<div class="card-body">
						<form action="<?= base_url('editStasiun') ?>" method="POST">
							...
							<button class="btn btn-block" style="background: #007bff; color: white;">Edit Nama Stasiun</button>
						</form>
					</div>
				</div>
			</div>
